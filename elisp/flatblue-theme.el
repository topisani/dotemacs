...
(let ((flatblue-dark0_hard  (if (display-graphic-p) "#1d2021" "color-234"))
  ...
  (custom-theme-set-faces
    ...
    `(linum                             ((t (:background ,flatblue-dark0 :foreground ,flatblue-dark4))))
    ...
    `(vertical-border                   ((t (:foreground ,flatblue-dark2))))
